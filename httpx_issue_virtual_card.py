...
open_debit_card_account_response = httpx.post("http://localhost:8003/api/v1/accounts/open-debit-card-account",
    json=open_debit_card_account_payload, timeout=10.0)

open_debit_card_account_response_data = open_debit_card_account_response.json()

print('UserId: ', create_user_response_data)
print("issue_debit_card_response: ",open_debit_card_account_response_data)
print("issue_debit_card_status_code: ",open_debit_card_account_response.status_code)
...
print("issue_virtual_card_response: ",issue_virtual_card_response_data)
print("issue_virtual_card_status_code: ",issue_virtual_card_response.status_code)