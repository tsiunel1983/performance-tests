...
print("make_top_up_operation_response_data: ",make_top_up_operation_response_data)
print("make_top_up_operation_response: ",make_top_up_operation_response.status_code)